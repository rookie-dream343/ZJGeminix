...
- [Signaler un Bug](https://github.com/Nagi-ovo/geminix/issues/new?template=bug_report.yml)
- [Suggérer une Fonctionnalité](https://github.com/Nagi-ovo/geminix/issues/new?template=feature_request.yml)

Merci de soutenir GeminiX ! ❤️
