...
**[GeminiX](https://github.com/Nagi-ovo/geminix)** 是一个完全免费且开源的浏览器扩展，旨在提升你的 Gemini 使用体验。如果这个扩展帮助你更高效地使用 Gemini，欢迎通过以下方式支持我继续开发和维护这个项目。
...
我非常推荐 **[Typeless (typeless.com)](https://www.typeless.com/refer?code=MZRYZP1)** 这款 AI 语音输入工具。在开发 GeminiX 的过程中，我将其整合进了日常工作流，极大地节省了我的时间并显著提升了整体开发效率。
