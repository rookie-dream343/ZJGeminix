...
- [バグ報告を提出する](https://github.com/Nagi-ovo/geminix/issues/new?template=bug_report.yml)
- [機能提案を提出する](https://github.com/Nagi-ovo/geminix/issues/new?template=feature_request.yml)

GeminiX をサポートしていただき、ありがとうございます！❤️
