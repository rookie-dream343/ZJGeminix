...
- [Reportar un Bug](https://github.com/Nagi-ovo/geminix/issues/new?template=bug_report.yml)
- [Solicitar una función](https://github.com/Nagi-ovo/geminix/issues/new?template=feature_request.yml)

¡Gracias por tu apoyo a GeminiX! ❤️
