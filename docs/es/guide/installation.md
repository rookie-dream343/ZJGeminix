...
[<img src="https://img.shields.io/badge/Microsoft_Edge-Ir_a_descargar-0078D7?style=for-the-badge&logo=microsoft-edge&logoColor=white" alt="Instalar desde Microsoft Edge Add-ons" height="40"/>](https://microsoftedge.microsoft.com/addons/detail/geminix/gibmkggjijalcjinbdhcpklodjkhhlne)

**Firefox:**

[<img src="https://img.shields.io/badge/Firefox_Add--ons-Ir_a_descargar-FF7139?style=for-the-badge&logo=firefox&logoColor=white" alt="Instalar desde Firefox Add-ons" height="40"/>](https://addons.mozilla.org/firefox/addon/geminix/)
...
1. Ve a [GitHub Releases](https://github.com/Nagi-ovo/geminix/releases) y descarga el último `geminix-chrome-vX.Y.Z.zip`.
2. Descomprímelo.
...
1. Ve a [Releases](https://github.com/Nagi-ovo/geminix/releases) y descarga el último `geminix-firefox-vX.Y.Z.xpi`.
...
_¿Quieres contribuir con código? Desarrolladores, por favor consulten la [Guía de Contribución](https://github.com/Nagi-ovo/geminix/blob/main/.github/CONTRIBUTING.md)._
