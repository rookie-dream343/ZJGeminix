...
GeminiX позволяет легко копировать математические формулы и научные символы. Поддерживается копирование исходного кода LaTeX и формата MathML, совместимого с Microsoft Word, в один клик.
