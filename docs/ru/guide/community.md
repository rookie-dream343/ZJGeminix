...
- [Сообщить об ошибке](https://github.com/Nagi-ovo/geminix/issues/new?template=bug_report.yml)
- [Предложить функцию](https://github.com/Nagi-ovo/geminix/issues/new?template=feature_request.yml)

Спасибо за поддержку GeminiX! ❤️
