...
teaser:
  ...
  description: 'Мы не хотели создавать очередное расширение. Мы хотели создать лучший способ мышления.<br>Когда вы используете GeminiX, вы перестаете бороться с интерфейсом и начинаете плыть вместе с ним.'
