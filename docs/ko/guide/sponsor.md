...
**[GeminiX](https://github.com/Nagi-ovo/geminix)**는 Gemini 경험을 향상시키기 위해 설계된 완전 무료 오픈 소스 브라우저 확장 프로그램입니다. 이 확장 프로그램이 Gemini를 더 효율적으로 사용하는 데 도움이 되었다면, 프로젝트의 지속적인 개발과 유지 관리를 위해 후원을 고려해 주세요.
