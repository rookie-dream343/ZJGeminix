...
> [!NOTE]
> Se o GeminiX for útil para você, compartilhe no X, Reddit, YouTube, etc. Cada partilha ajuda mais pessoas a descobrir o projeto e a melhorar a experiência com Gemini. Obrigado.
...
Se o GeminiX facilita a sua vida, considere pagar-me um café. Ajuda a manter as atualizações! Os patrocinadores serão destacados na nossa secção de Agradecimentos Especiais. ❤️
...
Recomendo vivamente o **[Typeless (typeless.com)](https://www.typeless.com/refer?code=MZRYZP1)**, uma ferramenta de voz para texto com IA que utilizei extensivamente durante o desenvolvimento do GeminiX. Poupou-me imenso tempo e aumentou significativamente a minha produtividade.
...
- **Issues**: Use os nossos templates de [relatório de erros](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) ou [pedido de funcionalidade](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/feature_request.yml).
- **Pull Requests**: Consulte [CONTRIBUTING.md](./CONTRIBUTING.md).

Obrigado por ajudar a tornar o GeminiX melhor! ❤️

---

## 🌟 Créditos

- **[DeepSeek Voyager](https://github.com/Azurboy/deepseek-voyager)** - Um fork do GeminiX adaptado para o DeepSeek.
