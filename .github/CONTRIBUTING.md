> **🌐 语言 / Language**: [中文](#贡献指南) | [English](#contributing-to-geminix) | [Español](CONTRIBUTING_ES.md) | [Français](CONTRIBUTING_FR.md) | [日本語](CONTRIBUTING_JA.md)
...
```bash
# 克隆仓库
git clone https://github.com/Nagi-ovo/geminix.git
cd geminix
...
GeminiX 通过以下功能增强 Gemini AI 聊天体验：
...
- 💬 [GitHub Discussions](https://github.com/Nagi-ovo/geminix/discussions) - 提问
- 🐛 [Issues](https://github.com/Nagi-ovo/geminix/issues) - 报告错误
- 📖 [文档](https://geminix.vercel.app/) - 阅读文档
...
Thank you for considering contributing to GeminiX! 🚀
...
GeminiX enhances the Gemini AI chat experience with:
...
- 💬 [GitHub Discussions](https://github.com/Nagi-ovo/geminix/discussions) - Ask questions
- 🐛 [Issues](https://github.com/Nagi-ovo/geminix/issues) - Report bugs
- 📖 [Documentation](https://geminix.vercel.app/) - Read the docs
