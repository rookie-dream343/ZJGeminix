...
> [!NOTE]
> Если GeminiX вам полезен, поделитесь им в X, Reddit, YouTube и т.д. Каждый репост помогает большему числу людей узнать о проекте и улучшать опыт использования Gemini. Спасибо.
...
Именно поэтому мы создали **GeminiX**. Это не просто инструмент, а помощник, который помогает организовать ваши диалоги с ИИ, сделать их доступными и продуктивными. Будь вы исследователем, ведущим десятки веток, разработчиком, сохраняющим фрагменты кода, или просто любителем порядка — Voyager создан для вас.
...
Если GeminiX делает вашу жизнь проще, вы можете угостить меня кофе. Это помогает продолжать работу над обновлениями! Спонсоры будут отмечены в разделе благодарностей. ❤️
...
Я настоятельно рекомендую **[Typeless (typeless.com)](https://www.typeless.com/refer?code=MZRYZP1)** — инструмент для перевода голоса в текст с ИИ, который я активно использовал во время разработки GeminiX.
...
- **Issues**: Используйте наши шаблоны для [отчетов об ошибках](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) или [предложений новых функций](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/feature_request.yml).
- **Pull Requests**: Ознакомьтесь с [CONTRIBUTING.md](./CONTRIBUTING.md).

Спасибо, что помогаете делать GeminiX лучше! ❤️

---

## 🌟 Благодарности

- **[DeepSeek Voyager](https://github.com/Azurboy/deepseek-voyager)** - Форк GeminiX, адаптированный для DeepSeek.
