...
A simple guide for installing GeminiX on Safari.
...
Get the latest `geminix-X.Y.Z.dmg` from [GitHub Releases](https://github.com/Nagi-ovo/geminix/releases).
...
1. Safari → Settings → Extensions → Uncheck GeminiX
2. Delete the app from Applications folder

---

**Need help?** Open an issue on [GitHub](https://github.com/Nagi-ovo/geminix/issues)
