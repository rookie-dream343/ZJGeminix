...
3. Click to download the configuration file (format: `geminix-folders-YYYYMMDD-HHMMSS.json`)
...
- **Format Version**: `geminix.folders.v1`
...
https://github.com/Nagi-ovo/geminix/issues/36
