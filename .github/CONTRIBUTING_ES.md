...
¡Gracias por considerar contribuir a GeminiX! 🚀
...
GeminiX mejora la experiencia de chat de Gemini AI con:
...
- 💬 [GitHub Discussions](https://github.com/Nagi-ovo/geminix/discussions) - Haz preguntas
- 🐛 [Issues](https://github.com/Nagi-ovo/geminix/issues) - Reporta errores
- 📖 [Documentación](https://geminix.vercel.app/) - Lee la documentación
