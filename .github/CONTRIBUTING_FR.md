...
Merci d'envisager de contribuer à GeminiX ! 🚀
...
GeminiX améliore l'expérience de chat Gemini AI avec :
...
- 💬 [GitHub Discussions](https://github.com/Nagi-ovo/geminix/discussions) - Poser des questions
- 🐛 [Issues](https://github.com/Nagi-ovo/geminix/issues) - Signaler des bugs
- 📖 [Documentation](https://geminix.vercel.app/) - Lire la documentation
