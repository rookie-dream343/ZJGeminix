...
> [!NOTE]
> إذا كان GeminiX مفيداً لك، فشاركْه على X أو Reddit أو YouTube إلخ. كل مشاركة تساعد المزيد من الناس على اكتشاف المشروع وتحسين تجربة Gemini. شكراً.
...
لهذا السبب قمنا ببناء **GeminiX**. إنه ليس مجرد أداة؛ إنه رفيق يساعدك في الحفاظ على تنظيم محادثاتك مع الذكاء الاصطناعي وجعلها سهلة الوصول ومنتجة. سواء كنت باحثاً تدير عشرات الخيوط، أو مطوراً يحفظ مقتطفات برمجية، أو مجرد شخص يحب النظام، فإن Voyager مصمم لك.
...
إذا كان GeminiX يسهل حياتك، فكر في دعوتي لتناول القهوة. يساعد ذلك في استمرار التحديثات! سيتم إدراج الداعمين في قسم الشكر الخاص بنا. ❤️
...
أوصي بشدة بـ **[Typeless (typeless.com)](https://www.typeless.com/refer?code=MZRYZP1)**، وهي أداة تحويل الصوت إلى نص بالذكاء الاصطناعي استخدمتها على نطاق واسع أثناء تطوير GeminiX. لقد وفرت لي الكثير من الوقت وزادت من إنتاجيتي بشكل كبير.
...
- **Issues**: استخدم نماذجنا لـ [تقرير الأخطاء](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) أو [طلب الميزات](https://github.com/Nagi-ovo/geminix/blob/main/.github/ISSUE_TEMPLATE/feature_request.yml).
- **Pull Requests**: تحقق من [CONTRIBUTING.md](./CONTRIBUTING.md).

شكراً لمساعدتك في جعل GeminiX أفضل! ❤️

---

## 🌟 الاعتمادات

- **[DeepSeek Voyager](https://github.com/Azurboy/deepseek-voyager)** - نسخة مشتقة من GeminiX مخصصة لـ DeepSeek.
